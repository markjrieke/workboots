...
[![Codecov test coverage](https://codecov.io/gh/markjrieke/workboots/branch/main/graph/badge.svg)](https://app.codecov.io/gh/markjrieke/workboots?branch=main)
<!-- badges: end -->
...
# load data from sysdata.rda (avoid re-fitting on knit)
workboots:::penguins_preds %>%
  summarise_predictions()
```
